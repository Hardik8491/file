    ...
    <div>
      <section className="contactUsWrap py-[4.5rem] md:py-[5.5rem] lg:py-[6.5rem] xl:py-[7.5rem] relative w-full">
       <span className="bg-accent absolute left-0 bottom-[-.75rem] h-6 w-1/2"></span>
        <div
          className="fixedBg bg-center bg-no-repeat before:absolute before:z-[1] before:inset-0 before:opacity-95 before:bg-[#284BE5] bg-[#284BE5] bg-blend-multiply xl:rounded-br-[20rem] lg:rounded-br-[18rem] md:rounded-br-[15rem] sm:rounded-br-[10rem] rounded-br-0  w-full overflow-hidden"
          style={{ background: "url(./secBg5.74d7502ab0306da82bb2.jpg) no-repeat center center " }}></div>
          ...
          <div className="contactUs grid gap-[1.875rem] lg:grid-cols-2 md:grid-cols-1 grid-cols-1 relative w-full">
              ...
              <div className="contactFormWrap relative w-full">
                <form className="grid gap-[1.875rem] md:grid-cols-2 grid-cols-1">
                  <div className="fieldBox w-full col-span-2">
                    <label className="text-[1rem] text-white font-Poppins font-medium px-[10px] md:px-[1.125rem] mb-[10px] block" htmlFor="text">
                      Write a Message
                    </label>
                    <textarea name="message type" id="text" cols={30}  rows={10} className="border-2 border-solid border-[#a9a9a9] focus:border-[rgba(255,255,255,.5)] focus:outline-0 bg-[transparent] rounded-[10px] md:rounded-[.9375rem] lg:rounded-[1.25rem] w-full h-[8rem] md:h-[13.125rem] p-[1.125rem] text-white"></textarea>
      
                  </div>
                  <div className="fieldBox w-full">
                    <label htmlFor="name"  className="text-[1rem] text-white font-Poppins font-medium px-[10px] md:px-[1.125rem] mb-[10px] block" >
                      Your Name
                    </label>
                  ...
                  <div className="fieldBox w-full">
                    <label htmlFor="emaill" className="text-[1rem] text-white font-Poppins font-medium px-[10px] md:px-[1.125rem] mb-[10px] block">
                      Your Email
                    </label>
                    <input
                      type="email"  aria-label="Search"
                      className="border-2 border-solid border-[#a9a9a9] focus:border-[rgba(255,255,255,.5)] focus:outline-0 bg-[transparent] rounded-[10px] md:rounded-[.9375rem] lg:rounded-[1.25rem] w-full h-[2.5rem] md:h-[3.875rem] p-[10px] md:p-[1.125rem] text-white"
                    />
                  </div>
            ...
            <div className="flex flex-col gap-[1.875rem] md:gap-[2.5rem] lg:gap-[3.4375rem]">
              <div className="conInfoList grid gap-[10px] grid-cols-1 relative w-full lg:pl-[6.25rem] md:pl-0 pl-0">
                <div className="conInfoBox border-[1px] border-dashed border-white flex gap-[1.0625rem] items-center w-full rounded-[10px] md:rounded-[.9375rem] lg:rounded-[1.25rem] lg:px-10 md:px-8 px-5 py-[1.75rem]">
                  <span>
                    <svg
                  ...
                  <div className="conInfoInner flex flex-col gap-1">
                    <h3 className="text-white font-Poppins font-bold text-[1.25rem] uppercase">
                      Los Angeles:
                    </h3>
