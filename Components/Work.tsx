...
const Work = () => {
  return (
    <section className="postsWrap py-[5rem] sm:py-[6rem] md:py-[7.5rem] relative w-full">
      ...
      <div className="px-4 md:px-[20rem] lg:px-[5rem] mx:auto">
        <div className="secTitleWrap flex flex-wrap justify-center items-center text-center w-full mb-[2.1875rem]">
        ...
        <div className="postsList flex flex-wrap items-center flex-col md:flex-row justify-center gap-[1.875rem]  relative w-full ">
          <div className="postBox group relative w-full md:w-[20rem] lg:w-[25rem]">
            <div className="postImg overflow-hidden rounded-[10px] sm:rounded-[1.25rem] md:rounded-[1.875rem] w-full md:w-[20rem] lg:w-[25rem]">
              <a
            ...
            <div className="postInfo relative z-[1] px-5 sm:px-8 md:px-10 py-5 sm:py-7 md:py-8 mt-[-4.6875rem] inset-x-[10px] max-w-[calc(100%-1.25rem)]">
              <div
                ...
                style={{
                  background: "url('./patternImg2.8de82b580f10424e5d2f.jpg')",
                }}></div>
          ...
          <div className="postBox group relative w-full md:w-[20rem] lg:w-[25rem]">
            ...
            <div className="postInfo relative z-[1] px-5 sm:px-8 md:px-10 py-5 sm:py-7 md:py-8 mt-[-4.6875rem] inset-x-[10px] max-w-[calc(100%-1.25rem)]">
              ...
              <span className="flex items-center text-accent gap-1 text-[1rem] font-NunitoSans font-bold">
                By
                <a className="hover:text-accent2" title="Martha Beth" href="/">
                  Martha Beth
                </a>
              </span>
            </div>
