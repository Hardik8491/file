            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[1.875rem]">
              <div className="gridItem">
                <div className="serviceBox flex flex-wrap gap-3 flex-col justify-center relative w-full z-[1] min-h-[20rem] md:min-h-[24.375rem] p-[1.875rem] md:p-7 lg:p-10 xl:p-[3.125rem]">
                  <div
                    className="serviceBg before:absolute before:inset-0 before:bg-accent before:rounded-[10px] before:sm:rounded-[1.25rem] before:md:rounded-[3.125rem] before:opacity-70 before:z-[1] bg-blend-multiply absolute rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] inset-0 bg-no-repeat bg-center bg-cover z-[-1] bg-accent" style={{
                        background:
                          "url('./pbg2.jpg') center / cover no-repeat  "
                      }}>
                    {/*  style='background-image: url("/static/media/patternImg2.8de82b580f10424e5d2f.jpg");'> */}
              ...
              <div className="gridItem">
                <div className="serviceBox flex flex-wrap gap-3 flex-col justify-center relative w-full z-[1] min-h-[20rem] md:min-h-[24.375rem] p-[1.875rem] md:p-7 lg:p-10 xl:p-[3.125rem]">
                  <div
                    className="serviceBg before:absolute before:inset-0 before:bg-[#f0e1d4] before:rounded-[10px] before:sm:rounded-[1.25rem] before:md:rounded-[3.125rem] before:opacity-70 before:z-[1] bg-blend-multiply absolute rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] inset-0 bg-no-repeat bg-center bg-cover z-[-1] bg-[#f0e1d4]" style={{
                        background:
                          "url('./pbg2.jpg') center / cover no-repeat  "
                      }}>
                    {/* // style='background-image: url("/static/media/patternImg2.8de82b580f10424e5d2f.jpg");'> */}
              ...
              <div className="gridItem">
                <div className="serviceBox flex flex-wrap gap-3 flex-col justify-center relative w-full z-[1] min-h-[20rem] md:min-h-[24.375rem] p-[1.875rem] md:p-7 lg:p-10 xl:p-[3.125rem]">
                  <div
                    className="serviceBg before:absolute before:inset-0 before:bg-[#d4e4f0] before:rounded-[10px] before:sm:rounded-[1.25rem] before:md:rounded-[3.125rem] before:opacity-70 before:z-[1] bg-blend-multiply absolute rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] inset-0 bg-no-repeat bg-center bg-cover z-[-1] bg-[#d4e4f0]"  style={{
                        background:
                          "url('./pbg2.jpg') center / cover no-repeat "
                      }}>
                    {/* style='background-image: url("/static/media/patternImg2.8de82b580f10424e5d2f.jpg");'> */}
              ...
              <div className="gridItem">
                <div className="serviceBox flex flex-wrap gap-3 flex-col justify-center relative w-full z-[1] min-h-[20rem] md:min-h-[24.375rem] p-[1.875rem] md:p-7 lg:p-10 xl:p-[3.125rem]">
                  <div
                    className="serviceBg before:absolute before:inset-0 before:bg-gray before:rounded-[10px] before:sm:rounded-[1.25rem] before:md:rounded-[3.125rem] before:opacity-70 before:z-[1] bg-blend-multiply absolute rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] inset-0 bg-no-repeat bg-center bg-cover z-[-1] bg-gray" style={{
                        background:
                          "url('./pbg2.jpg') center / cover no-repeat  "
                      }}>
                    {/*  style='background-image: url("/static/media/patternImg2.8de82b580f10424e5d2f.jpg");'> */}
